...
Prototype to see what it would be like to define a data specs version for CMIP7 based on the state of multiple repositories.
...
Having installed your virtual environment,
now you need to set up `esgvoc`.
...
From here, you can now run commands in your
